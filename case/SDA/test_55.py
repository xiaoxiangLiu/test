...
class TestCase(MyTestOn):
    ...
    def test_01(self):
        """
        多单持仓，限价全平，完全成交，验证委托状态、用户余额，手续费
        """
        logger.info("用例编号：55-1---多单持仓，限价全平，完全成交，验证委托状态、用户余额，手续费")
        range_num = 10
        price = 120*100000000
        buy_num = 100*100000000
        sell_num = 100*100000000
    ...
    def test_02(self):
        """
        空单持仓，限价全平，完全成交，验证委托状态、用户余额，手续费
        """
        logger.info("用例编号：55-2----空单持仓，限价全平，完全成交，验证委托状态、用户余额，手续费")
        range_num = 10
        price = 120*100000000
        buy_num = 100*100000000
        sell_num = 100*100000000
