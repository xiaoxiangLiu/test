...
class TestCase(MyTestOnTwo):
    ...
    def test_02(self):
        ...
        """
        logger.info("用例编号：61-2---空单持仓中，部分平仓，验证持仓余额，平仓委托中状态，用户余额，手续费")
        range_num = 10
        price = 20*100000000
        buy_num = 5*100000000
        ...
        flag_51 = assert_one(int(after_account_balance), 9999989851017118)
        flag_53 = assert_one(self.sda_balance - int(price * buy_num / 100000000), int(after_53_account_balance))
        self.assertListEqual([True, True], [flag_51, flag_53])
    ...
    def test_03(self):
        ...
        :return:
        """
        logger.info("用例编号：61-3---多单持仓中，部分限价平仓，市价多单与平多单成交，验证持仓余额，平仓委托中状态，用户余额，手续费")
        range_num = 10
        price = 20*100000000
        buy_num = 5*100000000
    ...
    def test_04(self):
        ...
        :return:
        """
        logger.info("用例编号：61-4---空单持仓中，部分限价平仓，市价空单与平空成交，验证持仓余额，平仓委托中状态，用户余额，手续费")
