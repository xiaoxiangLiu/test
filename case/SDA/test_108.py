...
class TestCase(MytestOnePlayer):
    ...
    def test_01(self):
        ...
        市价空单5倍杠杆委托，正常下单。
        """
        logger.info("用例编号：108-1--市价空单5倍杠杆委托，正常下单。")
        price = 100000000
        num = 100000000
    ...
    def test_03(self):
        ...
        市价空单20倍杠杆委托，正常下单。
        """
        logger.info("用例编号：108-3--市价空单20倍杠杆委托，正常下单。")
        price = 100000000
        num = 100000000
        ConnectMysql(_type=mysql_type).sda_clear_open_empty_close_multi_order(user_id=self.user_id, contract_id=sda_id,
                                                                              status=2)
    ...
    def test_04(self):
        ...
        市价空单50倍杠杆委托，正常下单。
        """
        logger.info("用例编号：108-4--市价空单50倍杠杆委托，正常下单。")
        price = 100000000
        num = 100000000
        ConnectMysql(_type=mysql_type).sda_clear_open_empty_close_multi_order(user_id=self.user_id, contract_id=sda_id,
                                                                              status=2)
    ...
    def test_05(self):
        ...
        市价空单100倍杠杆委托，正常下单。
        """
        logger.info("用例编号：108-5--市价空单100倍杠杆委托，正常下单。")
        price = 100000000
        num = 100000000
        ConnectMysql(_type=mysql_type).sda_clear_open_empty_close_multi_order(user_id=self.user_id, contract_id=sda_id,
                                                                              status=2)
