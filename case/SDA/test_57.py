...
class TestCase(MyTestOn):
    ...
    def test_01(self):
        ...
        """
        logger.info("用例编号：57--1---多单持仓中，限价全平，多个对应委托，成交其中部分委托，验证委托状态、用户余额、手续费。")
        ...
        for i in range(range_num):
            ...
            sync_53_id = JMESPathExtractor().extract(query="syncLockKey", body=buy_resp.text)
        ...
        flag_51 = assert_one(int(after_account_balance), 10000217795969075)
